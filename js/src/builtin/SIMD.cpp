...
static const JSFunctionSpec SIMD_static_methods[] = {
    JS_FN("add",          SIMD::add,    2, 0),
    JS_FN("mul",          SIMD::mul,    2, 0),
    JS_FN("addu32",       SIMD::addu32, 2, 0),
    JS_FN("mulu32",       SIMD::mulu32, 2, 0),
    JS_FS_END
};

bool
SIMD::add(JSContext *cx, unsigned argc, Value *vp)
{
...
bool
SIMD::mul(JSContext *cx, unsigned argc, Value *vp)
{
    CallArgs args = CallArgsFromVp(argc, vp);
...
bool
SIMD::addu32(JSContext *cx, unsigned argc, Value *vp)
{
    CallArgs args = CallArgsFromVp(argc, vp);
...
bool
SIMD::mulu32(JSContext *cx, unsigned argc, Value *vp)
{
    CallArgs args = CallArgsFromVp(argc, vp);
